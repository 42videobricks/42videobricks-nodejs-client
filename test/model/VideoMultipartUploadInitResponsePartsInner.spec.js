...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new 42videobricks.VideoMultipartUploadInitResponsePartsInner();
  });
  ...
  describe('VideoMultipartUploadInitResponsePartsInner', function() {
    it('should create an instance of VideoMultipartUploadInitResponsePartsInner', function() {
      ...
      //var instance = new 42videobricks.VideoMultipartUploadInitResponsePartsInner();
      //expect(instance).to.be.a(42videobricks.VideoMultipartUploadInitResponsePartsInner);
    });
